...
default_params <- list(
  ...
  area_width = 200,
  area_height = 200,
  simulation_time = 200,  # time steps
  ...
  # Mosquito parameters
  M = 100,  # initial number of mosquitoes # start at 50
  v = 2.0,  # base speed
  l = 0.3,  # light attraction strength
  Y = 3,    # offspring per successful bite
  survival_time = 80,  # time steps before death if no feeding
  bite_range = 10,  # distance within which mosquito can bite # start at 2
  window_entry_range = 5,  # distance to enter through window
  reproduction_cooldown = 20  # time steps between reproductions # start at 100
)
